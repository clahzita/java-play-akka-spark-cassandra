...
public class ActorController extends Controller {
	...
	public CompletionStage<Result> meuMetodo(String msg) {
		...
		SparkConf conf = new SparkConf(true)//
				.setAppName("MinhaApp")//
				.setMaster("spark://clarissa-Inspiron-5570:7077");
	...
	public CompletionStage<Result> listarPacotes() {
		PacoteInfoMsg msg = new PacoteInfoMsg();
		ActorRef listaPacotesActor = system.actorOf(ListarPacotesActor.getProps());
		return FutureConverters.toJava(ask(listaPacotesActor, msg, 2000))//
				.thenApply(response -> ok(listar.render((List<PacoteInfo>) response)));
	}
